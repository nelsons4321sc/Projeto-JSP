...
public class ModelLogin implements Serializable{
	...
	private List<ModelProduto2> produtos = new ArrayList<ModelProduto2>();
	...
	public void setProdutos(List<ModelProduto2> produtos) {
		this.produtos = produtos;
	}
	
	public List<ModelProduto2> getProdutos() {
		return produtos;
	}
...
public String getMostraProdutoRel() {
		...
		for (ModelProduto2 modelProduto : produtos) {
